...
Transparent PowerShell Edition - Version 0.25
===============================================================================
...
function Show-MainMenu {
    while ($true) {
        ...
        Write-Host "Transparent PowerShell Edition v0.25"
        Write-Host "======================================================================"
        Write-Host ""
...
REM Starts the installed background scheduler as a detached hidden process.
REM START returns immediately, allowing this temporary CMD window to close.
start "" powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "$InstalledPs1" -Scheduler
exit /b 0
"@
