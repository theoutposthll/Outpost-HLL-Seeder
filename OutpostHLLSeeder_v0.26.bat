...
REM ============================================================================
REM THE OUTPOST HLL AUTO-SEEDER - TRANSPARENT LAUNCHER - v0.26
REM ============================================================================
REM
...
REM Example:
REM     OutpostHLLSeeder_v0.26.bat
REM     OutpostHLLSeeder_v0.26.ps1
REM
...
if not exist "%PS1%" (
    ...
    echo Example:
    echo   OutpostHLLSeeder_v0.26.bat
    echo   OutpostHLLSeeder_v0.26.ps1
    echo.
    pause
    exit /b 2
)
