...
REM ============================================================================
REM THE OUTPOST HLL AUTO-SEEDER - TRANSPARENT LAUNCHER - v0.28
REM ============================================================================
REM
...
REM Example:
REM     OutpostHLLSeeder_v0.28.bat
REM     OutpostHLLSeeder_v0.28.ps1
REM
...
if not exist "%PS1%" (
    ...
    echo Example:
    echo   OutpostHLLSeeder_v0.28.bat
    echo   OutpostHLLSeeder_v0.28.ps1
    echo.
    pause
    exit /b 2
)
