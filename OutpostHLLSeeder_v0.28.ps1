...
Transparent PowerShell Edition - Version 0.28
===============================================================================
...
function Show-MainMenu {
    while ($true) {
        ...
        Write-Host "Transparent PowerShell Edition v0.28"
        Write-Host "======================================================================"
        Write-Host ""
...
function Install-OutpostSeeder {
    ...
    # Install the Outpost-supplied reference immediately from the extracted
    # release. It is not user data, so it is safe to refresh on every update.
    ...
    # v0.28 installed layout migration.
