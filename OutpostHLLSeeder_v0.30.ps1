...
Transparent PowerShell Edition - Version 0.30
===============================================================================
...
function Test-IniMatchesDefaultReference {
    ...
    $candidate = Get-NormalizedIniContent -Path $CandidatePath
    $reference = Get-NormalizedIniContent -Path $ReferencePath

    return ($candidate -ceq $reference)
}
    ...
    try {
        ...
        if ($liveLooksDefault) {
            ...
            if ($restoreSource) {
                ...
                Write-Log "HLL GameUserSettings.ini matched the known-default reference, but no non-default local backup exists. Nothing was changed."
            }
